...
import { Play, RotateCcw, Monitor, Code, HelpCircle, Lightbulb, CheckCircle2 } from 'lucide-react';
          ...
          <div className="flex gap-1">
            {['html', 'css', 'js'].map((lang) => (
              <button
                ...
                className={`px-4 py-2 text-sm font-medium uppercase rounded-t-md transition-colors ${
                  activeTab === lang 
        ...
        <div className="h-48 bg-surface border-t border-secondary/20 p-4 overflow-y-auto">
             ...
             {isSolved && (
                 <div className="mt-2 p-2 bg-green-900/20 text-green-200 text-xs rounded border border-green-500/20 flex items-center gap-2">
                     <CheckCircle2 size={14} /> Problem Solved! You can return to dashboard.
                 </div>
             )}
        </div>
      </div>
